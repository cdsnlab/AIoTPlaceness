...
def main():
    ...
    parser.add_argument('-trade_off', type=float, default=1e-06, help='trade_off value for semi-supervised learning')
...
def train_multidec(args):
    ...
    train_dataset, val_dataset = load_multi_csv_data(df_image_data, df_text_data, df_train, df_val, CONFIG)
    ...
    for arg, value in vars(args).items():
        exp.param(arg, value)
    try:
        mdec.fit(train_dataset, val_dataset, lr=args.lr, batch_size=args.batch_size, num_epochs=args.epochs,
