...
class OurModelFastM70(nn.Module):
    def __init__(self, Nc, Ns, Nt, c2v, n2v, Ms, cmask, smask, Ac, As, 
                 d_mv=70, d_ms=9, d_v=64, d_p=8, d_h=64, d_f=256, heads=2, optM=True):
        super(OurModelFastM70, self).__init__()
    ...
    def forward(self, m, c, p):
        ...
        if self.optM:
            ...
            mv = m[:, :, :self.d_mv].view(bs, self.Ns, self.d_mv)
