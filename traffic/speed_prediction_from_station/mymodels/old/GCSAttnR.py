...
class GCSAttnR(nn.Module):
    def __init__(self, Nc, Ns, Nt, c2v, n2v, Ms, cmask, smask, 
        ...
        self.GCW = Parameter(torch.randn(self.Ns, self.Nc), requires_grad=True)
    ...
    def forward(self, m, c, p):
        ...
        scores = self.GCW
        scores = scores.masked_fill(self.cmask == 1, -1e9)
