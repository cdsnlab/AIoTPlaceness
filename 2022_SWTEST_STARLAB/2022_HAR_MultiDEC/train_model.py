...
tf.compat.v1.set_random_seed(args.gpu)
...
X_idx = np.arange(train_y.shape[0]).reshape(-1, 1)
X_idx2, y_resampled2 = ros.fit_resample(X_idx, train_y)
train_X = train_X[X_idx2.flatten()]
train_y = y_resampled2
